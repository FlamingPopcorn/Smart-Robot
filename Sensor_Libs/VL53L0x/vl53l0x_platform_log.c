...
#include <stdlib.h>  // Fixes 'malloc' and 'free'
#include <stdarg.h>  // Fixes 'va_start' and 'va_end'

// Fixes the undeclared 'VL53L0X_MAX_STRING_LENGTH_PLT'
#ifndef VL53L0X_MAX_STRING_LENGTH_PLT
    #define VL53L0X_MAX_STRING_LENGTH_PLT 128
#endif
